...
<h1 class="wrap">Вы искали &ldquo;<?php echo search_term(); ?>&rdquo;.</h1>
...
<?php else: ?>
	<p class="wrap">К сожалению, по запросу &ldquo;<?php echo search_term(); ?>&rdquo; ничего не найдено. Всё правильно?</p>
<?php endif; ?>
